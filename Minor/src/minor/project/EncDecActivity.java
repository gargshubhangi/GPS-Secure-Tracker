...
public class EncDecActivity extends Activity {
	...
	GeocodeActivity myobj= new GeocodeActivity();
	
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.encdec_main);

		recNum = (EditText) findViewById(R.id.recNum);
		secretKey = (EditText) findViewById(R.id.secretKey);
		
		msgContent = (EditText) findViewById(R.id.plainText);
		
		send = (Button) findViewById(R.id.Send);
		cancel = (Button) findViewById(R.id.cancel);

		String myplace = myobj.myplace;
		Toast.makeText(getApplicationContext(), myplace, Toast.LENGTH_SHORT).show();
		//msgContent.setText(myobj.myplace);
		msgContent.setText(myplace, TextView.BufferType.EDITABLE);
